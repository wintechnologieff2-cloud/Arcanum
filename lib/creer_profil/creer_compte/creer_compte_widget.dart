...
import 'creer_compte_model.dart';
export 'creer_compte_model.dart';

class CreerCompteWidget extends StatefulWidget {
  const CreerCompteWidget({super.key});

  static String routeName = 'CreerCompte';
  static String routePath = '/creerCompte';

  @override
  State<CreerCompteWidget> createState() => _CreerCompteWidgetState();
}

class _CreerCompteWidgetState extends State<CreerCompteWidget> {
  late CreerCompteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreerCompteModel());
    ...
    _model.confmotDePasseTextController ??= TextEditingController();
    _model.confmotDePasseFocusNode ??= FocusNode();
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              '_model.adresseCourrielTextController',
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.confmotDePasseTextController,
                          focusNode: _model.confmotDePasseFocusNode,
                          autofocus: false,
                          enabled: true,
                          textInputAction: TextInputAction.go,
                          obscureText: !_model.confmotDePasseVisibility,
                          decoration: InputDecoration(
                            isDense: true,
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '8bytom4d' /* Confirmer mot de passe */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                            ...
                            suffixIcon: InkWell(
                              onTap: () async {
                                safeSetState(() =>
                                    _model.confmotDePasseVisibility =
                                        !_model.confmotDePasseVisibility);
                              },
                              focusNode: FocusNode(skipTraversal: true),
                              child: Icon(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (_model.motDePasseTextController.text !=
                                _model.confmotDePasseTextController.text) {
                            ...
                            context.goNamedAuth(
                              Creervotreprofil01Widget.routeName,
                              context.mounted,
